...
--
-- Servidor: db
-- Tiempo de generación: 04-01-2024 a las 20:56:48
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_fk_category` FOREIGN KEY (`id_category`) REFERENCES `category` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
